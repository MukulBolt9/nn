...
class MainViewModel(
    ...
    fun checkForUpdates(currentVersion: String, skippedVersion: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                // Always fetch /releases/latest — GitHub always points this to the newest non-prerelease
                ...
                if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    // Strip leading "v" → "v1.2" becomes "1.2"
                    ...
                    if (cleanedTag.isNotBlank()
                        ...
                        _updateAvailable.value = UpdateInfo(
                            ...
                            url = "https://github.com/MukulBolt9/xz/releases/latest"
                        )
                    }
                }
            } catch (e: Exception) {
